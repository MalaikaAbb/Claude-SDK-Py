...
- [CopilotPopup](/claude-sdk-python/prebuilt-components/popup) and [CopilotSidebar](/claude-sdk-python/prebuilt-components/sidebar): the prebuilt surfaces that own modal state.
...
- [Slots](/claude-sdk-python/custom-look-and-feel/slots): the `messageView` / `assistantMessage` slot system used above.
- [Programmatic Control](/claude-sdk-python/programmatic-control): driving agent runs from code without a chat UI.
