...
<Callout type="info" title="Prebuilt thread UI: Threads Drawer">
  ...
  prebuilt **[Threads Drawer](/claude-sdk-python/prebuilt-components/copilot-threads-drawer)**.
...
<Callout type="info" title="Migrating existing history?">
  ...
  [Import & Synchronize Thread History](/claude-sdk-python/threads-import), or jump to
...
<Steps>
      <Step>
        ...
        Production self-hosting uses the same React APIs and is deployed with CopilotKit Engineering through [Self-host CopilotKit Intelligence](/claude-sdk-python/intelligence/self-hosting).
...
- **Prebuilt UI:** [Threads Drawer](/claude-sdk-python/prebuilt-components/copilot-threads-drawer) — the drop-in thread switcher ([React reference](/reference/components/CopilotThreadsDrawer))
- **Thread architecture:** [Threads & Persistence Architecture](/claude-sdk-python/intelligence/threads-explained) — event replay model and WebSocket sync
- **Production self-hosting:** [Self-host CopilotKit Intelligence](/claude-sdk-python/intelligence/self-hosting) — run the Threads platform inside your infrastructure with CopilotKit Engineering
