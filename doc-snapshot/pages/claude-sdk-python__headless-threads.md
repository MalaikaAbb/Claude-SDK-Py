...
- **Thread architecture:** [Threads & Persistence Architecture](/claude-sdk-python/premium/threads-explained) — event replay model and WebSocket sync
- **Production self-hosting:** [Self-host CopilotKit Intelligence](/claude-sdk-python/premium/self-hosting) — run the Threads platform inside your infrastructure with CopilotKit Engineering
